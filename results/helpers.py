...
def createDirectories():
    ...
    directories = [graphicsDirectory, depthSearchGraphicsDirectory, greedySearchGraphicsDirectory,
...
def plotThreeGraphics(plt, greedy_agent_cost_y, breadth_search_cost_y, 
